  ...
  return (
    <Router>
      <div className="d-flex flex-column justify-content-start align-items-center mt-5">
        <div className="card p-4 shadow rounded w-100" style={{ maxWidth: "900px", minHeight: "50vh" }}>
          <Nav />
          <div className="mt-4">
            <Routes>
              <Route path="/" element={<Songs />} />
              <Route path="/playlist" element={<PlaylistAgregadas playlist={lista} onDeletePlaylist={handleDeletePlaylist}/>} />
              <Route path="/playlist/:id" element={<PlaylistDetails />} />
              <Route path="/add-musicas" element={<AddSong />} />
              <Route path="/add-playlist" element={<AddPlaylist onPlaylistCreated={fetchLista}/>} />
